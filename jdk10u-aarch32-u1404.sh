...
# boot jdk
$D wget -nv https://github.com/ojdkbuild/contrib_jdk10u-ci/releases/download/jdk-10.0.1%2B10/jdk-10.0.1-ojdkbuild-linux-x64.zip
$D unzip -q jdk-10.0.1-ojdkbuild-linux-x64.zip
$D mv jdk-10.0.1-ojdkbuild-linux-x64 bootjdk

# cacerts
$D wget -nv ${OJDK_CACERTS_URL} -O cacerts

# sources
$D wget -nv http://hg.openjdk.java.net/jdk-updates/jdk10u/archive/${OJDK_TAG}.tar.bz2
